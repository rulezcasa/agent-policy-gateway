...
import type { Decision, IngestionPolicy, IngestionPolicyUpdate, PolicyCondition } from "@/lib/types";
import { PolicyCategoryBadge } from "./policy-badges";
...
export function ConnectedRuleReviewCard({ policy, onConfirm, onPark, onEdit }: { policy: IngestionPolicy; onConfirm: () => Promise<void>; onPark: () => Promise<void>; onEdit: (update: IngestionPolicyUpdate) => Promise<void> }) {
