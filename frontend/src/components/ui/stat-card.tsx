...
export function StatCard({ label, value, detail, tone = "slate", icon }: { label: string; value: number; detail: string; tone?: "slate" | "indigo" | "rose" | "amber"; icon: ReactNode }) {
  const tones = { slate: "bg-slate-100 text-slate-700", indigo: "bg-indigo-50 text-indigo-700", rose: "bg-rose-50 text-rose-700", amber: "bg-amber-50 text-amber-700" };
